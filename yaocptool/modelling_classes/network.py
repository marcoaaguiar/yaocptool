...
class Network:
    ...
    def createConnections(self):
        for connection_id in self.connections_settings_dict:
            ...
            self.connection_dict[connection_id] = Connection(connection_id= connection_id, nodes = nodes, z_sym_indeces_list= z_sym_indeces_list)
...
class Connection:
    def __init__(self, connection_id, nodes =[], z_sym_indeces_list = {}):
        self.connection_id = connection_id
        self.nodes = nodes
        self.associated_z_sym = [nodes[0].model.z_sym[z_sym_indeces_list[0]], nodes[1].model.z_sym[z_sym_indeces_list[1]]]
