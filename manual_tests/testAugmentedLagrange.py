...
from manual_tests.models.linear_models import (
    MIMO2x2DAE,
    StabilizationMIMO2x2WithInequality,
)
...
if AUG_LAGRANGIAN:
    ...
    solution_method = AugmentedLagrangian(
        problem,
...
if INDIRECT:
    ...
    figs = result2.plot(
        {"x": [0, 1]}, {"u": "all"}, {"y": [2, 3]}, figures=figs, show=True
    )
