...
def create_four_tanks():
    ...
    # Pump Connections
    n.connect(
        nodes_pumps[0].model.y[0],
        nodes_tank[0].model.u[0],
        nodes_pumps[0],
        nodes_tank[0],
    )
    n.connect(
        nodes_pumps[0].model.y[1],
        nodes_tank[3].model.u[0],
        nodes_pumps[0],
        nodes_tank[3],
    )
    n.connect(
        nodes_pumps[1].model.y[0],
        nodes_tank[1].model.u[0],
        nodes_pumps[1],
        nodes_tank[1],
    )
    n.connect(
        nodes_pumps[1].model.y[1],
        nodes_tank[2].model.u[0],
        nodes_pumps[1],
        nodes_tank[2],
    )
...
def create_two_pumps_two_tanks():
    ...
    n.connect(
        nodes_pumps[1].model.y[0],
        nodes_tank[0].model.u[1],
        nodes_pumps[1],
        nodes_tank[0],
    )
    n.connect(
        nodes_pumps[1].model.y[1],
        nodes_tank[1].model.u[1],
        nodes_pumps[1],
        nodes_tank[1],
    )
...
if CLASSIC:
    ...
    c_solution_method = DirectMethod(
        centralized_problem,
